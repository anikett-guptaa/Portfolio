      ...
      <div className="absolute top-0 left-0 w-[100%] overflow-hidden bg-[#111]">
        ...
        <div className="text-white bg-[#111]  flex flex-col items-center justify-between space-y-8  font-serif">
          ...
          <div className="flex flex-row justify-between items-center space-x-10 sm:space-x-16">
            <a
              href="https://www.linkedin.com/in/aniket-gupta-726903309/"
              target="_blank"
            >
              <svg
                className="sm:w-9 w-6 hover:text-white hover:scale-110 ease-in-out duration-200"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
              >
                <path
            ...
            <a href="https://github.com/anikett-guptaa" target="_blank">
              <svg
                className="sm:w-9 w-6 hover:text-white hover:scale-110 ease-in-out duration-200"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 496 512"
            ...
            <a
              href="mailto:aniketgt12328@gmail.com"
